...
export class CcursoService {
  private apiUrl = 'https://api.projetointegradorawspi.duckdns.org/course/';  // URL principal para cursos
  private disciplinesUrl = 'https://api.projetointegradorawspi.duckdns.org/subject/';  // URL para buscar as disciplinas
