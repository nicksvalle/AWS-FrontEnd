...
export class ProfessoresService {
  private apiUrl = 'https://api.projetointegradorawspi.duckdns.org/teacher/';  // Nova URL da API
  private cursosUrl = 'https://api.projetointegradorawspi.duckdns.org/courses'; // Caso precise acessar cursos também
