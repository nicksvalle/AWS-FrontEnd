...
export class GradeFixaService {
  private apiUrl = 'https://api.projetointegradorawspi.duckdns.org/reservation/';
  private teachersUrl = 'https://api.projetointegradorawspi.duckdns.org/teacher/';
  private subjectsUrl = 'https://api.projetointegradorawspi.duckdns.org/subject/';
  private timesUrl = 'https://api.projetointegradorawspi.duckdns.org/time/';
  private roomsUrl = 'https://api.projetointegradorawspi.duckdns.org/rooms/';
  private coursesUrl = 'https://api.projetointegradorawspi.duckdns.org/course/';
